 ...
 * Time: 14-8-19 上午9:08
 */
public class JumpCirclePageIndicator extends View implements PageIndicator {
    ...
    public JumpCirclePageIndicator(Context context) {
        this(context, null);
    }

    public JumpCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, com.viewpagerindicator.R.attr.vpiCirclePageIndicatorStyle);
    }

    @SuppressWarnings("deprecation") // setBackgroundDrawable方法在API16以上弃用.
    public JumpCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
